...
run_once({"nm-applet"})  -- Autostart nm-applet at startup
...
local modkey       = "Mod4"
local altkey       = "Mod1"
local mehkey       = {modkey, altkey, "Control"}
local terminal = "alacritty"
local editor = "emacs" -- os.getenv("EDITOR") or "vi"
local editor_cmd = "emacs" -- terminal .. " -e " .. editor
...
globalkeys = mytable.join(
    ...
    -- X screen locker
    awful.key({ modkey, "Ctrl" }, "l", function () os.execute(scrlocker) end,
    ...
    -- User programs
    awful.key({ modkey, altkey }, "w", function () awful.spawn(browser) end,
              {description = "run browser", group = "launcher"}),

    awful.key({ modkey, altkey }, "e", function () awful.spawn("emacs") end,
...
clientkeys = mytable.join(
    awful.key({ modkey, "Control"}, "o", lain.util.magnify_client,
